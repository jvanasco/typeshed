...
class RequestValidator:
    ...
    def get_default_scopes(self, client_id, request, *args, **kwargs) -> List: ...
    def get_original_scopes(self, refresh_token, request, *args, **kwargs) -> List: ...
    ...
    def save_token(self, token, request, *args, **kwargs) -> str: ...
    ...
    def get_code_challenge(self, code, request) -> Optional[str]: ...
